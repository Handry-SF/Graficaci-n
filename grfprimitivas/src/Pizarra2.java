...
public class Pizarra2 extends javax.swing.JFrame {
    ...
    private void dibujarCuadrado(Point p1, Point p2, Point p3, Point p4, Color c) {
        Vertex2D v1 = new Vertex2D(p1.x, p1.y, c.getRGB());
        Vertex2D v2 = new Vertex2D(p2.x, p2.y, c.getRGB());
        Vertex2D v3 = new Vertex2D(p3.x, p3.y, c.getRGB());
        Vertex2D v4 = new Vertex2D(p4.x, p4.y, c.getRGB());

        Cuadrado cuadrado = new Cuadrado(v1, v2, v3, v4, c);

        cuadrado.dibujar(raster);

        aFiguras.add(cuadrado);
...
//        }
//
//        if (figura == CUADRADO && bP1 && bP2 && !bP3) {
//            p3.x = evt.getX();
//            p3.y = evt.getY();
//            bP3 = true;
...
//            dibujarCuadrado(p1, p2, p3, color);
//            bP1 = false;
//            bP2 = false;
//            bP3 = false;
//        }
//    }
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {
        figura = this.rbLinea.isSelected() ? LINEA : (this.rbTriang.isSelected() ? TRIANGULO : CUADRADO);
        ...
        if (figura == CUADRADO && bP1 && bP2 && bP3 && !bP4) {
            p4.x = evt.getX();
            p4.y = evt.getY();
            bP4 = true;
            System.out.println("Cuarto punto: " + p4);
        ...
        if (figura == CUADRADO && bP1 && bP2 && bP3 && bP4) {
            System.out.println("Dibujando cuadrado");
            dibujarCuadrado(p1, p2, p3, p4, color);
            bP1 = false;
            bP2 = false;
            bP3 = false;
            bP4 = false;
