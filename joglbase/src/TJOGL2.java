...
public class TJOGL2 extends GLJPanel implements GLEventListener, KeyListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        this.texturaPiramide = this.cargarTextura("imagenes/avengers.jpg"); // Reemplaza "tu_imagen.jpg" con la ruta de tu imagen
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        this.texturaPiramide.bind(gl);
        this.texturaPiramide.enable(gl);

        this.drawPyramid(2.0f, 0.0f, 0.0f, 1.0f, 1.0f, gl);

        this.texturaPiramide.disable(gl);
...
/*    void drawPyramid(float x, float y, float z, float w, float h, GL2 gl) {
        ...
        // Renderiza la pirámide con la textura
        //gl.glPushMatrix();
